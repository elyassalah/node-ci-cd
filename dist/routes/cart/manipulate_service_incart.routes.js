...
const manipulateServiceInCart = (0, express_1.Router)();
manipulateServiceInCart.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.body;
        const { user_id, service_id, service_incart_id, box_and_choices } = userData;
        let allData = {};
        ...
        if (cart !== "failure") {
            ...
            if (newService === true) {
                ...
                const allChoicesOfServiceInCart = yield (0, functions_1.getAllData)({
                ...
                for (let index in box_and_choices) {
                    ...
                    for (let subIndex in allChoicesOfServiceInCart) {
                        ...
                        if (box_and_choices[index]["boxId"] ===
                            ...
                            for (let subIndex2 in box_and_choices[index]["choicesId"]) {
                                ...
                                if (box_and_choices[index]["choicesId"][subIndex2] ===
                            ...
                            if (removeOldChoice === true) {
                                ...
                                const count = yield (0, functions_1.deleteData)("user_selected_choices_request", "choice_id =? AND box_id = ? AND user_id = ? AND service_incart_id = ?", [
                                    allChoicesOfServiceInCart[subIndex]["choice_id"],
                                    allChoicesOfServiceInCart[subIndex]["box_id"],
                                    user_id,
                                    service_incart_id,
                    ...
                    if (isNewBox === true) {
                        ...
                        for (let subIndex3 in box_and_choices[index]["choicesId"]) {
                            ...
                            for (let subIndex4 in allChoicesOfServiceInCart) {
                                if (box_and_choices[index]["choicesId"][subIndex3] ===
                ...
                for (let index in allChoicesOfServiceInCart) {
                    ...
                    for (let subIndex in box_and_choices) {
                        if (allChoicesOfServiceInCart[index]["box_id"] ==
...
exports.default = manipulateServiceInCart;
